...
<html>
    ...
    <head>
        <title>Hotel Secretos - Reservaciones</title>
       ...
       <%@include file='WEB-INF/jspf/header.jspf' %>
                ...
                <div class="container">
                    ...
                    <form  class="row text-center" action="ServletMisReservas">
                        ...
                        <div class="col-md-4">
                             <button class="btnAplicar" type="submit" name="op" id=""  value="aplicarAdmi">APLICAR</button>
                             <a href="ServletMisReservas?op=mostrarTodasAdmi" class="btnMostarTodas" >MOSTRAR TODAS</a>
                        </div>
                        ...
                        <table class="table table-hover text-center">
                                 ...
                                 <tr>
                                     ...
                                     <td><a href=""><%=reservaciones.getDni()%></a></td>
                                     <td>
...
<jsp:forward page="index.jsp">
    <jsp:param name="msg2" value="Administrador no logueado"/>
</jsp:forward>
